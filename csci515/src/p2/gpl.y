...
variable_declaration:
    simple_type  T_ID  optional_initializer {
        ...
        if ($1 == INT)          scopemgr.add_to_current_scope(std::make_shared<Symbol>(*$2, new int(42)));
        else if ($1 == DOUBLE)  scopemgr.add_to_current_scope(std::make_shared<Symbol>(*$2, new double(3.14159)));
        else if ($1 == STRING)  scopemgr.add_to_current_scope(std::make_shared<Symbol>(*$2, new std::string("Hello world")));
