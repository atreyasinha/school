...
%type <union_statement_ptr> exit_statement
                                                                             ...
                                                                             * 
                                                                             ********************************************************/
%type <union_statement_ptr> repeat_statement
                                                                            /*********************************************************
                                                                             * 
                                                                             * 
                                                                             *              CODE ADDED FOR TEST END
...
repeat_statement:
    T_REPEAT statement_or_block_of_statements T_UNTIL T_LPAREN expression T_RPAREN T_SEMIC {
        if ($5->type() == INT)      $$ = new Repeat($2, $5);
        else {
