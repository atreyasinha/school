  ...
  switch (type)
  {
    ...
    case INVALID_TYPE_FOR_FOR_STMT_EXPRESSION:
      ...
      cerr << "Incorrect type for expression in for statement."
           ...
           << endl;
      break;
    case INVALID_TYPE_FOR_REPEAT_STMT_EXPRESSION:
      error_header();
      cerr << "Incorrect type for expression in a repeat-until statement."
           << "  Expressions in repeat-until statements must be of type INT."
           << endl;
      break;
