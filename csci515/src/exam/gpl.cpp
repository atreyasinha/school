...
int main(int argc, char **argv)
{
  ...
  catch(Gpl_type badtype) { Error::error(Error::INVALID_TYPE_FOR_RESERVED_VARIABLE, "window_x", gpl_type_to_string(badtype), "int"); }
  ...
  catch(Gpl_type badtype) { Error::error(Error::INVALID_TYPE_FOR_RESERVED_VARIABLE, "window_y", gpl_type_to_string(badtype), "int"); }
  ...
  catch(Gpl_type badtype) { Error::error(Error::INVALID_TYPE_FOR_RESERVED_VARIABLE, "window_width", gpl_type_to_string(badtype), "int"); }
  ...
  catch(Gpl_type badtype) { Error::error(Error::INVALID_TYPE_FOR_RESERVED_VARIABLE, "window_height", gpl_type_to_string(badtype), "int"); }
  ...
  catch(Gpl_type badtype) { Error::error(Error::INVALID_TYPE_FOR_RESERVED_VARIABLE, "window_red", gpl_type_to_string(badtype), "double"); }
  ...
  catch(Gpl_type badtype) { Error::error(Error::INVALID_TYPE_FOR_RESERVED_VARIABLE, "window_green", gpl_type_to_string(badtype), "double"); }
  ...
  catch(Gpl_type badtype) { Error::error(Error::INVALID_TYPE_FOR_RESERVED_VARIABLE, "window_blue", gpl_type_to_string(badtype), "double"); }
  ...
  catch(Gpl_type badtype) { Error::error(Error::INVALID_TYPE_FOR_RESERVED_VARIABLE, "window_title", gpl_type_to_string(badtype), "string"); }
  ...
  catch(Gpl_type badtype) { Error::error(Error::INVALID_TYPE_FOR_RESERVED_VARIABLE, "animation_speed", gpl_type_to_string(badtype), "int"); }
