...
const Constant* Near::evaluate() const {
    ...
    return ret(new Integer_constant(lhs_constant->as_game_object()->near(rhs_constant->as_game_object())));
}
...
const Constant* Touches::evaluate() const {
    ...
    return ret(new Integer_constant(lhs_constant->as_game_object()->touches(rhs_constant->as_game_object())));
}