...
class Not : public Unary_operator {
  public:
    Not(const Expression* lhs) : Unary_operator(lhs){};
    virtual const Constant* evaluate() const;
    virtual Gpl_type type() const;
};
...
class Cosine : public Unary_operator {
  public:
    Cosine(const Expression* lhs) : Unary_operator(lhs){};
    virtual const Constant* evaluate() const;
    virtual Gpl_type type() const;
};
...
class Sine : public Unary_operator {
  public:
    Sine(const Expression* lhs) : Unary_operator(lhs){};
    virtual const Constant* evaluate() const;
    virtual Gpl_type type() const;
};
...
class Tan : public Unary_operator {
  public:
    Tan(const Expression* lhs) : Unary_operator(lhs){};
    virtual const Constant* evaluate() const;
    virtual Gpl_type type() const;
};
...
class Acos : public Unary_operator {
  public:
    Acos(const Expression* lhs) : Unary_operator(lhs){};
    virtual const Constant* evaluate() const;
    virtual Gpl_type type() const;
};
...
class Asin : public Unary_operator {
  public:
    Asin(const Expression* lhs) : Unary_operator(lhs){};
    virtual const Constant* evaluate() const;
    virtual Gpl_type type() const;
};
...
class Atan : public Unary_operator {
  public:
    Atan(const Expression* lhs) : Unary_operator(lhs){};
    virtual const Constant* evaluate() const;
    virtual Gpl_type type() const;
};
...
class Sqrt : public Unary_operator {
  public:
    Sqrt(const Expression* lhs) : Unary_operator(lhs){};
    virtual const Constant* evaluate() const;
    virtual Gpl_type type() const;
};
...
class Abs : public Unary_operator {
  public:
    Abs(const Expression* lhs) : Unary_operator(lhs){};
    virtual const Constant* evaluate() const;
    virtual Gpl_type type() const;
};
...
class Floor : public Unary_operator {
  public:
    Floor(const Expression* lhs) : Unary_operator(lhs){};
    virtual const Constant* evaluate() const;
    virtual Gpl_type type() const;
};
...
class Random : public Unary_operator {
  public:
    Random(const Expression* lhs) : Unary_operator(lhs){};
    virtual const Constant* evaluate() const;
    virtual Gpl_type type() const;
};
...
class Unary_minus : public Unary_operator {
  public:
    Unary_minus(const Expression* lhs) : Unary_operator(lhs){};
    virtual const Constant* evaluate() const;
    virtual Gpl_type type() const;
};
